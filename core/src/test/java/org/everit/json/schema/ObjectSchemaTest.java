...
public class ObjectSchemaTest {
    ...
    private static final JsonObject OBJECTS;

    static {
        // get resource stream
        InputStream stream = ObjectSchemaTest.class.getResourceAsStream("/org/everit/jsonvalidator/objecttestcases.json");
        // create reader
    ...
    public void multipleAdditionalProperties() {
        ...
        try {
            subject.validate(Json.createObjectBuilder().add("a", true).add("b", true).build());
    ...
    public void patternPropertyOnEmptyObjct() {
        ObjectSchema.builder()
            ...
            .build().validate(Json.createObjectBuilder().build());
    }
